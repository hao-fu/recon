...
public class Log {
    ...
    public static void updateFileName() {
        if (Setting.getOutputDirectory() != null) {
            File file = new File(Setting.getOutputDirectory());
            ...
            fileName = Setting.getOutputDirectory() + File.separator + Setting.getAppName() + ".log";
    ...
    private static boolean writeLog(String TAG, int theLevel, String title,
        ...
        if (fileName != null && theLevel >= Setting.getLogLevel()) {
            Writer output;
